...
Handles the B10 removal for Level-2A compatibility.
...
# =========================================
# Step 2: Convert PyTorch Weights to Keras
# =========================================
...
def convert_to_keras(pth_path, output_path, input_channels=12):
    ...
    # ===================================
    # Build Keras ResNet50 architecture
    # ===================================
    ...
    # ======================================================
    # Build mapping from PyTorch keys to Keras layer names
    # ======================================================
